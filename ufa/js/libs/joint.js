...
V = Vectorizer = (function() {
    ...
    VElement.prototype = {
        ...
        getTransformToElement: function(toElem) {
            ...
            // if(toElem.getScreenCTM()){
            //     return toElem.getScreenCTM().inverse().multiply(this.node.getScreenCTM());
            // }else{
            //     // console.log($('#applicationDiagram').find('svg')[0]);
            //     t = document.getElementById('applicationDiagram').firstChild;
            //     return t.getScreenCTM().inverse().multiply(this.node.getScreenCTM());
            // }
