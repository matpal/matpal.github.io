joint.shapes.uml.AndroidApplication = joint.shapes.basic.Generic.extend({

    markup: [
        '<g class="rotatable">',
          '<g class="scalable">',
            '<rect class="component-name-rect"/>',
          '</g>',
          '<text class="component-name-text"/><image/>',
        '</g>'
    ].join(''),
...
joint.shapes.uml.AndroidComponent = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.btn.del>text': { fill: '#000','font-size': 16, 'font-weight': 500, stroke: "#000", x: -5, y: 6, 'font-family': 'sans' },
        },
